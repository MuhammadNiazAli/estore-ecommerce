          ...
          {questions.map(({ id, question, answer }) => (
            ...
            >
              <div className="flex-1">
                <p className="text-amber-600 font-semibold text-lg mb-1">{question}</p>
                ...
                {editingId === id ? (
                  <input
                    ...
                    className="w-full sm:w-[300px] px-4 py-2 bg-white text-gray-900 border border-amber-700 rounded-md placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-600"
                ...
                {editingId === id ? (
                  <>
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-full bg-amber-600 hover:bg-amber-500 text-gray-900 font-semibold text-sm transition"
                    >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-amber-600 hover:bg-amber-500 text-gray-900 font-semibold shadow-lg transition text-sm sm:text-base"
                  >
