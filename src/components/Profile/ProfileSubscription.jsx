...
const statusStyles = {
  Active: 'bg-black/90 text-black',
  Expired: 'bg-black/90 text-black',
  Pending: 'bg-black/90 text-black',
};
      ...
      <div className="w-full max-w-[900px] mx-auto space-y-6">
        ...
        >
          <div className="flex-1 space-y-2">
            <p className="text-black text-lg font-semibold">{subscription.planName}</p>
          ...
          <div className="flex gap-3 sm:gap-4">
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-black hover:bg-black text-gray-900 font-semibold shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-white hover:bg-gray-500 text-black font-semibold shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
