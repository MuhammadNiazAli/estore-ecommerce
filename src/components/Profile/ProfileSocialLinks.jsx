          ...
          <AnimatePresence>
            {accounts.map(({ id, platform, username, icon }) => (
              <motion.div
                ...
                className="bg-gray-800 rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-md"
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {editingId === id ? (
                      <input
                        type="text"
                        className="mt-1 bg-gray-900 text-white border border-yellow-500 px-2 py-1 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-400 text-sm w-full sm:w-[200px]"
                  ...
                  {editingId === id ? (
                    ...
                    <>
                      <button
                        ...
                        className="p-2 rounded-full hover:bg-yellow-400 hover:text-gray-900 transition"
          ...
          {deletingId && (
            ...
            >
              <motion.div
                ...
                animate={{ scale: 1 }}
                exit={{ scale: 0.8 }}
                className="bg-gray-900 rounded-xl p-6 w-[90%] max-w-md text-white shadow-2xl"
              >
