...
const ProfileActivityLog = () => {
  ...
  return (
    <section
      className="w-full max-w-[1200px] mx-auto bg-white text-gray-900 rounded-lg px-4 py-8 sm:px-8 sm:py-12 md:px-10 md:py-14"
          ...
          {paginatedActivities.map(({ id, type, icon: Icon, description, timestamp }) => (
            ...
            >
              ...
              <div className="flex flex-col">
                <p className="text-gray-900 font-semibold text-sm sm:text-base md:text-lg">{description}</p>
                <time
