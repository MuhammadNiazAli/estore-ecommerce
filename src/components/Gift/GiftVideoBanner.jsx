...
export default function GiftVideoBanner() {
  return (
    <motion.section
      ...
      className="relative max-w-[1000px] mx-auto rounded-lg overflow-hidden shadow-2xl bg-gradient-to-tr from-amber-800 via-amber-600 to-amber-400"
    >
      ...
      <div className="absolute inset-0 bg-white bg-opacity-80 flex flex-col justify-center items-center px-6 sm:px-12 text-center">
        <motion.h2
          ...
          className="text-amber-950 text-3xl sm:text-4xl md:text-5xl font-extrabold drop-shadow-md mb-2 font-sans"
        >
        ...
        <motion.p
          ...
          className="text-amber-950 max-w-xl mb-8 text-base sm:text-lg md:text-xl leading-relaxed drop-shadow-sm"
        >
        ...
        <motion.a
          ...
          className="inline-block bg-amber-950 text-amber-300 font-extrabold px-8 py-3 rounded-full shadow-lg hover:bg-amber-900 focus:outline-none focus:ring-4 focus:ring-amber-900 focus:ring-opacity-50 transition-transform transform hover:scale-105 focus:scale-105"
