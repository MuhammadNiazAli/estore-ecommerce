...
export default function GiftOccasionTabs() {
  ...
  return (
    <section
      className="max-w-[1100px] mx-auto p-6 sm:p-10 bg-white rounded-2xl shadow-2xl text-black select-none"
      aria-label="Gift ideas by occasion"
    >
      <h2 className="text-black text-3xl sm:text-4xl font-extrabold mb-10 text-center drop-shadow-md tracking-wide font-sans">
        ...
        {occasions.map(({ id, label }) => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 whitespace-nowrap px-6 py-3 rounded-full font-semibold text-base transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-black my-1 focus:ring-opacity-60
      ...
      <div className="mt-10 min-h-[140px] sm:min-h-[160px] px-4 sm:px-0">
        <AnimatePresence mode="wait" initial={false}>
          <motion.div
            ...
            className="bg-white bg-opacity-20 rounded-xl shadow-md text-black max-w-3xl mx-auto text-center text-lg sm:text-xl leading-relaxed select-text px-6 py-8 font-sans"
          >
