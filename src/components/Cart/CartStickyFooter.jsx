...
const CartStickyFooter = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-white/60 backdrop-blur-md border-t border-gray-200 z-50 my-[-2px]">
      <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row items-center justify-between px-3 sm:px-6 py-2 sm:py-3 gap-2 sm:gap-4 text-xs sm:text-sm">
        ...
        <Link
          href="/shop"
          className="text-gray-600 hover:text-gray-900 transition underline underline-offset-2 whitespace-nowrap"
        >
          ← Continue Shopping
        </Link>
