  ...
  return (
    <div className="w-full bg-white text-gray-900 flex justify-center px-4 sm:px-6 py-16 min-h-[300px]">
      <div className="max-w-[1000px] w-full flex flex-col items-center text-center gap-6">
        <ShoppingCartIcon className="w-20 h-20 text-amber-600 opacity-70" />

        <h2 className="text-3xl sm:text-4xl font-bold text-amber-600">
          Your Cart is Empty
        </h2>
        ...
        <button
          ...
          className="mt-4 px-8 py-3 bg-amber-600 hover:bg-amber-500 text-gray-900 font-semibold rounded-full transition shadow-lg"
        >
          Continue Shopping
        </button>
      </div>
