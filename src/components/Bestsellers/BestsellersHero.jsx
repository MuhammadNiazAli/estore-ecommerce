...
const BestsellerParallaxHero = () => {
  ...
  const mobileContent = (
    <section
      ...
      className="w-full min-h-[320px] bg-black flex flex-col items-center justify-center p-6 text-black select-none my-[-50px] mb-0"
    >
      ...
      <a
        ...
        className="bg-white text-black font-semibold py-2 px-5 rounded-md shadow-lg hover:bg-gray-500 transition"
  ...
  return (
    <>
      ...
      <section
        ...
        className="relative w-full min-h-[520px] md:min-h-[720px] flex flex-col md:flex-row items-center bg-white text-black overflow-hidden select-none hidden md:flex my-[-50px] mb-0"
      >
        {/* Parallax background */}
        <div
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 py-10 md:py-16 flex flex-col md:flex-row md:items-center md:justify-between w-full gap-10 md:gap-16">
          ...
          <article className="max-w-xl md:max-w-md space-y-6">
            ...
            <p className="text-black text-base sm:text-lg drop-shadow-md leading-relaxed">
              {product.description}
            </p>
            ...
            <div className="flex gap-4 sm:gap-6 mt-6 flex-wrap">
              <a
                href={product.shopLink}
                className="bg-black hover:bg-black text-gray-900 font-semibold py-3 px-6 sm:px-8 rounded-lg shadow-lg transition-transform transform hover:scale-105 focus:outline-black focus:ring-2 focus:ring-black text-center"
              ...
              <a
                ...
                className="border border-black hover:border-black text-black hover:text-black font-semibold py-3 px-6 sm:px-8 rounded-lg shadow-inner transition-transform transform hover:scale-105 focus:outline-black focus:ring-2 focus:ring-black text-center"
          ...
          <div className="hidden md:block relative w-[420px] h-[480px] rounded-xl overflow-hidden shadow-2xl flex-shrink-0 ring-1 ring-black ring-opacity-80">
            <img
              src={product.image}
              alt={product.title}
            ...
            />
            {/* subtle glow ring */}
            <div className="absolute inset-0 rounded-xl ring-4 ring-black opacity-20 animate-pulse pointer-events-none" />
          </div>
        </div>
      </section>
    </>
