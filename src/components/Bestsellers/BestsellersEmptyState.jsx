...
const BestsellersEmptyState = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative overflow-hidden h-[45vh] flex flex-col items-center justify-center bg-gray-900 text-yellow-400 select-none my-16 mb-0 px-4 sm:px-6 lg:px-8"
    >
      ...
      <div className="relative z-10 max-w-xl text-center">
        ...
        <p className="text-lg sm:text-xl text-yellow-300 mb-8 drop-shadow-md">
          We're crafting the perfect collection for you. Check back soon to find exclusive deals and top-rated items!
        </p>
        <button
          type="button"
          className="inline-block rounded-full bg-yellow-500 px-8 py-3 font-semibold text-black hover:bg-yellow-400 transition-shadow shadow-lg hover:shadow-yellow-300/20"
        >
          Explore Collections
        </button>
      </div>
