    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-black mb-2">
          Stay Inspired with Art Tips & Exclusive Offers
        </h2>
        <p className="text-black mb-6">
          Subscribe to our newsletter for the latest trends, artist spotlights, and special deals on art supplies!
        </p>
        <form
...
export default ArtNewsletterSignup;
