...
const artProducts = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1724204400833-19548ab66a91?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE1fHwzRHxlbnwwfHwwfHx8MA%3D%3D",
    price: "$350",
    specs: ["Acrylic on Canvas", "24x36 inches", "Framed"],
  },
  {
    id: 2,
    name: "Modern Metal Sculpture",
    image:
      "https://images.unsplash.com/photo-1634848860108-6d8368f5a0b3?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE3fHwzRHxlbnwwfHwwfHx8MA%3D%3D",
    price: "$500",
    specs: ["Steel", "18 inches tall", "Indoor use"],
  },
  {
    id: 3,
    name: "Vintage Art Print",
    image:
      "https://images.unsplash.com/photo-1654140785899-6148f8fa06f9?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTI0fHwzRHxlbnwwfHwwfHx8MA%3D%3D",
    price: "$120",
    specs: ["High-quality print", "18x24 inches", "Limited edition"],
  },
];
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Art Products</h2>
                <button
