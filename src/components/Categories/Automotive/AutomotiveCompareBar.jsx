...
const automotiveProducts = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1650508310957-f6c6df04d742?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjc1fHxjaWNsZSUyMHBhcnRzfGVufDB8fDB8fHww",
    price: "$45",
    specs: ["Durable Rubber", "Anti-Slip", "Easy to Clean"],
  },
  {
    id: 2,
    name: "LED Headlight Bulbs",
    image:
      "https://images.unsplash.com/photo-1666256361541-8807d3809df0?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mjc5fHxjaWNsZSUyMHBhcnRzfGVufDB8fDB8fHww",
    price: "$60",
    specs: ["Bright White Light", "Long Lifespan", "Energy Efficient"],
  },
  {
    id: 3,
    name: "Synthetic Engine Oil 5W-30",
    image:
      "https://images.unsplash.com/photo-1682426312577-14ad7b489af9?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjgxfHxjaWNsZSUyMHBhcnRzfGVufDB8fDB8fHww",
    price: "$39",
    specs: ["Full Synthetic", "Improves Performance", "Protects Engine"],
  },
];

const AutomotiveCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Automotive Products</h2>
                <button
...
export default AutomotiveCompareBar;
