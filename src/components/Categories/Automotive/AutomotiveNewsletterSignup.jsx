...
const AutomotiveNewsletterSignup = () => {
    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-amber-600 mb-2">
          Stay Updated with Our Latest Automotive Deals
        </h2>
        <p className="text-amber-500 mb-6">
          Subscribe to our newsletter and never miss out on new car accessories and offers!
        </p>
        <form
...
export default AutomotiveNewsletterSignup;
