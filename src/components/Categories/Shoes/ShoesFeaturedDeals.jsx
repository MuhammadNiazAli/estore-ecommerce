...
const ShoesFeaturedDeals = () => {
  ...
  const totalSlides = Math.ceil(shoesDeals.length / cardsPerSlide);
  ...
  for (let i = 0; i < totalSlides; i++) {
    slideItems.push(shoesDeals.slice(i * cardsPerSlide, i * cardsPerSlide + cardsPerSlide));
  }

  return (
    <section className="bg-white text-gray-900 py-12 px-6 max-w-[1200px] mx-auto rounded-lg shadow-xl select-none">
      <h2 className="text-3xl font-extrabold mb-8 text-center">Shoes Featured Deals</h2>
...
export default ShoesFeaturedDeals;
