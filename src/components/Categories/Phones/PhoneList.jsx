...
const Toast = ({ message, onClose }) => {
  ...
  return (
    <div
      role="alert"
      aria-live="assertive"
      className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-black px-6 py-3 rounded shadow-lg z-50 font-semibold text-sm select-none"
    >
      {message}
    </div>
  );
          ...
          >
            <div className="relative">
              ...
              <button
                ...
                className="absolute top-3 right-3 text-2xl text-red-500 hover:scale-110 transition-transform z-10 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 rounded"
                type="button"
      ...
      {visibleCount < phonesData.length && (
        <div className="flex justify-center mt-12">
          <button
            ...
            className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full font-semibold text-base hover:from-blue-500 hover:to-indigo-500 transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-indigo-400"
            type="button"
