...
const collectiblesProducts = [
  {
    id: 1,
    name: "Vintage Coin Set",
    image:
      "https://plus.unsplash.com/premium_photo-1676490733323-cb6b91f3c8de?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTg0fHxjb2xsZWN0aWJsZXN8ZW58MHx8MHx8fDA%3D",
    price: "$350",
    specs: ["Rare Mint", "Collector's Edition", "Includes Certificate"],
  },
  {
    id: 2,
    name: "Autographed Baseball",
    image:
      "https://images.unsplash.com/photo-1593746299512-5bf6a074bc00?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTg3fHxjb2xsZWN0aWJsZXN8ZW58MHx8MHx8fDA%3D",
    price: "$500",
    specs: ["Signed by Legend", "With Case", "Authenticated"],
  },
  {
    id: 3,
    name: "Retro Action Figure",
    image:
      "https://images.unsplash.com/photo-1628071711153-d0204a351a6e?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTk3fHxjb2xsZWN0aWJsZXN8ZW58MHx8MHx8fDA%3D",
    price: "$120",
    specs: ["1980s Original", "Sealed Packaging", "Limited Edition"],
  },
];

const CollectiblesCompareBar = () => {
...
export default CollectiblesCompareBar;
