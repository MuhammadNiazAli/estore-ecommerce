...
const CollectiblesNewsletterSignup = () => {
    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-amber-600 mb-2">
          Get the Latest on Rare Finds & Collector Drops
        </h2>
        <p className="text-amber-500 mb-6">
          Sign up for insider news, exclusive collectible releases, and limited-edition alerts delivered to your inbox!
        </p>
        <form
...
export default CollectiblesNewsletterSignup;
