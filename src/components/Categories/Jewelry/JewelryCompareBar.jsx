...
const jewelryProducts = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1578632297758-3a6c6de14be8?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTAyfHxqZXdlbHJ5fGVufDB8fDB8fHww",
    price: "$1200",
    specs: ["18K Gold", "Adjustable Length", "Handcrafted"],
  },
  {
    id: 2,
    name: "Diamond Stud Earrings",
    image:
      "https://images.unsplash.com/photo-1578469488462-96f9af23e4b8?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTAwfHxqZXdlbHJ5fGVufDB8fDB8fHww",
    price: "$800",
    specs: ["0.5 Carat Diamonds", "White Gold", "Hypoallergenic"],
  },
  {
    id: 3,
    name: "Silver Charm Bracelet",
    image:
      "https://plus.unsplash.com/premium_photo-1670590820749-23047072c280?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTA5fHxqZXdlbHJ5fGVufDB8fDB8fHww",
    price: "$350",
    specs: ["Sterling Silver", "Adjustable Size", "Includes 5 Charms"],
  },
  {
    id: 4,
    name: "Platinum Wedding Ring",
    image:
      "https://plus.unsplash.com/premium_photo-1681276169690-a22f1193c784?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTEzfHxqZXdlbHJ5fGVufDB8fDB8fHww",
    price: "$2200",
    specs: ["Platinum", "Comfort Fit", "Custom Engraving"],
  },
];

const JewelryCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Jewelry Products</h2>
                <button
...
export default JewelryCompareBar;
