...
// Health Products Array (Add all 50 here)
const healthProducts = [
  {
    id: 1,
    name: "Organic Multivitamin Tablets",
    image:
      "https://images.unsplash.com/photo-1580377968242-daed42865732?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODN8fG1lZGljYWx8ZW58MHx8MHx8fDA%3D",
    price: "$25",
    specs: ["Boost Immunity", "All-Natural", "No Artificial Colors"],
  },
  {
    id: 2,
    name: "Whey Protein Powder (1kg)",
    image:
      "https://images.unsplash.com/photo-1670516537499-e3aafaac25b0?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTE4fHxtZWRpY2FsfGVufDB8fDB8fHww",
    price: "$45",
    specs: ["High Protein", "Low Sugar", "Gluten-Free"],
  },
  {
    id: 3,
    name: "Herbal Green Tea (Pack of 100)",
    image:
      "https://images.unsplash.com/photo-1618093877862-3630a08f737f?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTI2fHxtZWRpY2FsfGVufDB8fDB8fHww",
    price: "$18",
    specs: ["Detox", "Rich in Antioxidants", "Natural Flavor"],
  },
  // ✅ Add the remaining 47 products from your full health dataset
];

const HealthCompareBar = () => {
  ...
  return (
    <div className="bg-white text-green-yellow p-6 my-10">
      {/* Products Grid */}
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Health Products</h2>
                <button
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[600px] table-auto border-collapse">
                  <thead>
                    <tr>
                      <th className="border-b border-amber-700 p-3 text-left">
                        Feature
                      </th>
                      {compareItems.map((item) => (
                        <th
...
export default HealthCompareBar;
