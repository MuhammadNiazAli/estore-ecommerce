...
const gardenProducts = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1539470090907-7cc242c37af5?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTI2fHxuYXR1cmV8ZW58MHx8MHx8fDA%3D",
    price: "$25",
    specs: ["Durable", "Elegant", "Indoor/Outdoor"],
  },
  {
    id: 17,
    name: "Watering Can",
    image:
      "https://images.unsplash.com/photo-1725133306731-fd82b613300f?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTI5fHxuYXR1cmV8ZW58MHx8MHx8fDA%3D",
    price: "$15",
    specs: ["Ergonomic", "Lightweight"],
  },
  {
    id: 18,
    name: "Indoor Plant Stand",
    image:
      "https://images.unsplash.com/photo-1503965830912-6d7b07921cd1?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTQyfHxuYXR1cmV8ZW58MHx8MHx8fDA%3D",
    price: "$40",
    specs: ["Wooden", "Modern Design"],
  },
  {
    id: 19,
    name: "Gardening Gloves",
    image:
      "https://images.unsplash.com/photo-1444464666168-49d633b86797?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTQxfHxuYXR1cmV8ZW58MHx8MHx8fDA%3D",
    price: "$12",
    specs: ["Breathable", "Comfortable Grip"],
  },
  {
    id: 20,
    name: "Succulent Plant Pack",
    image:
      "https://images.unsplash.com/photo-1652418365134-7991f0e1744b?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTQ4fHxuYXR1cmV8ZW58MHx8MHx8fDA%3D",
    price: "$35",
    specs: ["Low Maintenance", "Decorative"],
  },
    {
    id: 29,
    name: "dead beauty Plant",
    image:
      "https://plus.unsplash.com/premium_photo-1726611993654-557bfdde474f?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTQzfHxuYXR1cmV8ZW58MHx8MHx8fDA%3D",
    price: "$35",
    specs: ["Low Maintenance", "Decorative"],
  },
];

const GardenCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Garden Products</h2>
                <button
...
export default GardenCompareBar;
