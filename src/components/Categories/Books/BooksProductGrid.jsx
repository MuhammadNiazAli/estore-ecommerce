...
const BooksProductGrid = () => {
  ...
  const [products, setProducts] = useState(booksData.slice(0, 9));
  const [hoveredId, setHoveredId] = useState(null);

  const handleLoadMore = () => {
    const newCount = visibleCount + 9;
    setVisibleCount(newCount);
    setProducts(booksData.slice(0, newCount));
  };
    ...
    <section className="bg-gray-900 text-white py-12 px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          <h2 className="text-2xl font-bold">Explore Books Collection</h2>
