...
export const petsData = [
  ...
  {
    id: 49,
    name: "Cat Litter Scoop with Holder",
    brand: "CleanPurr",
    category: "Litter",
    price: 12,
    rating: 4,
    stock: true,
    image: "https://plus.unsplash.com/premium_photo-1726797744225-f2c2d5407bf4?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDMyfHx8ZW58MHx8fHx8",
    features: ["Durable Plastic", "Easy to Store"],
  },
  {
    id: 50,
    ...
    rating: 5,
    stock: true,
    image: "https://images.unsplash.com/photo-1640748728172-f808c211f57d?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDM0fHx8ZW58MHx8fHx8",
    features: ["Toothbrush & Paste", "Fresh Breath"],
  }

];


const PetsProductGrid = () => {
  const [sortOption, setSortOption] = useState("");
  const [visibleCount, setVisibleCount] = useState(6);
  const [products, setProducts] = useState(petsData.slice(0, 6));
  const [hoveredId, setHoveredId] = useState(null);

  const handleLoadMore = () => {
    const newCount = visibleCount + 6;
    setVisibleCount(newCount);
    setProducts(petsData.slice(0, newCount));
  };
  ...
  const handleSort = (value) => {
    ...
    if (value === "low-high") {
      ...
      sortedProducts = petsData.slice(0, visibleCount);
    }
    ...
    <section className="bg-white text-gray-900 py-12 px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          <h2 className="text-2xl font-bold">Pet Essentials Collection</h2>
...
export default PetsProductGrid;
