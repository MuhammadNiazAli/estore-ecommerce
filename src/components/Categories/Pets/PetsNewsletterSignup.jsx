...
const PetsNewsletterSignup = () => {
  const [email, setEmail] = useState("");

  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Thanks for signing up, ${email}! Get ready for pet care tips and special deals.`);
    setEmail("");
  };
    ...
    <section className="bg-gray-900 py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-yellow-400 mb-2">
          Stay Ahead in Pet Care with Our Tips & Offers
        </h2>
        <p className="text-yellow-300 mb-6">
          Subscribe to our newsletter for expert pet advice, health tips, and exclusive discounts!
        </p>
        <form
...
export default PetsNewsletterSignup;
