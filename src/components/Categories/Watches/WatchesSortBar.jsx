...
const WatchesSortBar = ({ onSortChange, onSearchChange, onViewChange, onItemsPerPage }) => {
  ...
  return (
    <div className="w-full bg-white text-black py-3 px-4 md:px-8 top-0 z-50 shadow-lg my-15">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-3 w-full md:w-auto">
          ...
          <div className="w-full md:w-72">
            <input
              ...
              className="w-full rounded-lg bg-white text-gray-900 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-black placeholder-gray-400"
