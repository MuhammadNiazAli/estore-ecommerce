...
const babyProducts = [
  {
    ...
    image:
      "https://plus.unsplash.com/premium_photo-1680089167384-0fa83af0d414?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTQzfHxiYWJ5fGVufDB8fDB8fHww",
    price: "$18",
    specs: ["100% Organic Cotton", "Machine Washable", "Available in 3 Sizes"],
  },
  {
    id: 2,
    name: "Infant Stroller",
    image:
      "https://images.unsplash.com/photo-1563521940479-140e6e311385?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTY0fHxiYWJ5fGVufDB8fDB8fHww",
    price: "$220",
    specs: ["Lightweight", "Foldable", "Adjustable Handle"],
  },
  {
    id: 3,
    name: "Baby Feeding Bottle Set",
    image:
      "https://images.unsplash.com/photo-1497319892902-e0a47680bb6b?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTkzfHxiYWJ5fGVufDB8fDB8fHww",
    price: "$35",
    specs: ["BPA Free", "Leak Proof", "Includes 3 Bottles"],
  },
];

const BabyCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Baby Products</h2>
                <button
