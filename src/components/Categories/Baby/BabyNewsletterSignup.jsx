    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-amber-600 mb-2">
          Get the Latest Baby Care Tips & Deals
        </h2>
        <p className="text-amber-500 mb-6">
          Subscribe to our newsletter for helpful advice and special offers on baby products!
        </p>
        <form
...
export default BabyNewsletterSignup;
