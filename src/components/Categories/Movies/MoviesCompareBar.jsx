...
const movieProducts = [
  {
    ...
    name: "Inception",
    image:
      "https://plus.unsplash.com/premium_photo-1709842822358-006f08261139?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzIwfHxtb3ZpZXxlbnwwfHwwfHx8MA%3D%3D",
    price: "$19",
    specs: ["Blu-ray", "1080p HD", "Digital Copy"],
  },
  {
    id: 2,
    name: "The Dark Knight",
    image:
      "https://images.unsplash.com/photo-1622732776612-1232b64eb1a3?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzE0fHxtb3ZpZXxlbnwwfHwwfHx8MA%3D%3D",
    price: "$15",
    specs: ["DVD", "720p HD", "Bonus Scenes"],
  },
  {
    id: 3,
    name: "Interstellar",
    image:
      "https://plus.unsplash.com/premium_photo-1683740128093-89c50ee1ce6d?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzI4fHxtb3ZpZXxlbnwwfHwwfHx8MA%3D%3D",
    price: "$18",
    specs: ["Blu-ray", "4K UHD", "Digital Code"],
  },
];

const MoviesCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Movies</h2>
                <button
...
export default MoviesCompareBar;
