...
const MoviesNewsletterSignup = () => {
  const [email, setEmail] = useState("");

  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Thanks for signing up, ${email}! Get ready for the latest movie updates.`);
    setEmail("");
  };
    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-amber-600 mb-2">
          Stay Updated with the Latest Movies & Deals
        </h2>
        <p className="text-amber-500 mb-6">
          Subscribe to our newsletter for movie news, reviews, and exclusive offers!
        </p>
        <form
...
export default MoviesNewsletterSignup;
