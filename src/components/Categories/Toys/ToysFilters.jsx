...
const ToysFilters = () => {
  ...
  return (
    <div className="bg-gray-900 text-white py-8 my-[-50px]">
      <div className="max-w-[1200px] mx-auto px-4 flex flex-col lg:flex-row gap-8 relative">
        ...
        <div className="lg:hidden sticky top-20 z-40">
          <button
            className="bg-yellow-500/80 text-black px-4 py-1 rounded-full shadow-lg flex items-center gap-2"
        ...
        {/* ✅ Sidebar Filters */}
        <aside
          className={`fixed top-0 left-0 h-full w-72 bg-gray-800 z-50 p-6 transform transition-transform duration-300 ease-in-out overflow-y-auto custom-scrollbar
        ...
        >
          ...
          {/* Material */}
          <div className="mb-4">
            <h3 className="font-semibold mb-2 text-yellow-400">Material</h3>
