    ...
    <div className="bg-white text-gray-900 py-8 my-[-50px]">
      <div className="max-w-[1200px] mx-auto px-4 flex flex-col lg:flex-row gap-8 relative">
        ...
        <div className="lg:hidden sticky top-20 z-40">
          <button
            className="bg-amber-700/80 text-black px-4 py-1 rounded-full shadow-lg flex items-center gap-2"
        ...
        >
          ...
          {/* Material */}
          <div className="mb-4">
            <h3 className="font-semibold mb-2 text-amber-600">Material</h3>
