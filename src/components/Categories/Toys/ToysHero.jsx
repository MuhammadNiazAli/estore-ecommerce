    ...
    <section className="w-full bg-gray-900 text-white py-16 lg:py-24 my-[-50px]">
      <div className="mx-auto max-w-[1200px] px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left">
          <div className="inline-block bg-yellow-600 text-white px-4 py-1 rounded-full text-sm font-semibold">
          ...
          <div className="flex justify-center lg:justify-start gap-5 flex-wrap">
            <button className="bg-yellow-500 text-white px-7 py-3 rounded-full font-semibold shadow-md hover:bg-yellow-400 transition duration-300 ease-in-out">
              Shop Now
            </button>
