...
// Sample Beauty / Nature Products Data
export const beautyData = [
  ...
  },
  {
    ...
    category: "Indoor Plant",
    price: 95,
    features: ["Air Purifying", "Medium Light", "Easy Care"],
    rating: 5,
    stock: true,
    image:
      "https://plus.unsplash.com/premium_photo-1681807331836-74c62f6ccab0?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDYwfHx8ZW58MHx8fHx8",
  },
  {
    id: 50,
    name: "Bougainvillea",
    ...
    category: "Outdoor Plant",
    price: 55,
    features: ["Bright Flowers", "Sun Loving", "Climbing Vine"],
    rating: 4,
    stock: true,
    image:
      "https://plus.unsplash.com/premium_photo-1668073438756-76fe6a233c56?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDY2fHx8ZW58MHx8fHx8",
  },
];
...
const BeautyProductGrid = () => {
  ...
  const [products, setProducts] = useState(beautyData.slice(0, 6));
  const [hoveredId, setHoveredId] = useState(null);

  const handleLoadMore = () => {
    const newCount = visibleCount + 6;
    setVisibleCount(newCount);
    setProducts(beautyData.slice(0, newCount));
  };
    ...
    <section className="bg-white text-gray-900 py-12 px-4">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          <h2 className="text-2xl font-bold">Explore Natural Beauty</h2>
        ...
        <div className="text-center mt-8">
          {visibleCount < beautyData.length && (
            <button
