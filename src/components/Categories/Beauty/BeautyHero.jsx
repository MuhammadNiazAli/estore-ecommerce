...
// ✅ Beauty Model Component
const BeautyModel = ({ scale }) => {
  const groupRef = useRef();
  const { scene } = useGLTF("/models/potted_plant_02_2k.gltf");
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (width < 640) {
        ...
        // Desktop → Smaller model & pushed back camera
      ...
      <div className="mx-auto max-w-[1200px] px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-300 max-w-md mx-auto lg:mx-0 text-lg leading-relaxed">
            Explore premium potted plants designed to enhance your home or
            office with elegance and a touch of nature.
          </p>

          <div className="bg-gray-800/60 p-4 rounded-xl inline-block">
            <p className="text-3xl font-bold text-yellow-400">$129</p>
