...
const sampleHomeDecorProducts = [
  {
    id: 1,
    name: "Elegant Vase Set",
    image:
      "https://images.unsplash.com/photo-1693813977701-53850521778e?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDExNXx8fGVufDB8fHx8fA%3D%3D",
    price: "$49",
    specs: ["Ceramic", "Matte Finish", "Hand Painted"],
  },
  {
    id: 2,
    name: "Wooden Coffee Table",
    image:
      "https://images.unsplash.com/photo-1615044010418-2ef6f75ab808?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDExOXx8fGVufDB8fHx8fA%3D%3D",
    price: "$299",
    specs: ["Solid Wood", "Modern Design", "Eco Friendly"],
  },
  {
    id: 3,
    name: "Abstract Wall Art",
    image:
      "https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDEyNHx8fGVufDB8fHx8fA%3D%3D",
    price: "$89",
    specs: ["Canvas Print", "Vibrant Colors", "Ready to Hang"],
  },
];

const HomeDecorCompareBar = () => {
  ...
  return (
    <div className="bg-white text-amber-600 p-4 my-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
        {sampleHomeDecorProducts.map((product) => (
          <div
            key={product.id}
          ...
          >
            ...
            <button
              className="mt-2 w-full px-3 py-2 bg-amber-700 text-gray-900 rounded hover:bg-amber-600 font-semibold transition"
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-4">
                <h2 id="compare-modal-title" className="text-xl font-bold">
                  Compare Home Decor
                </h2>
                <button
...
export default HomeDecorCompareBar;
