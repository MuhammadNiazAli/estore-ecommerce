...
// ✅ Home Decor Model Component
const HomeDecorModel = ({ scale }) => {
  const groupRef = useRef();
  const { scene } = useGLTF("/models/mid_century_lounge_chair_2k.gltf");
  ...
  return (
    <primitive
      ...
      object={scene}
      scale={scale}
      position={[0, -1, 0]} // ✅ Adjusted position so chair sits nicely
    />
  );
};

// ✅ HomeDecorHero Section
const HomeDecorHero = () => {
      ...
      <div className="mx-auto max-w-[1200px] px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-300 max-w-md mx-auto lg:mx-0 text-lg leading-relaxed">
            Discover timeless lounge chairs crafted to bring sophistication and
            unmatched comfort to your living space.
          </p>
        ...
        >
          ...
          >
            ...
            <HomeDecorModel scale={modelScale} />
            <ContactShadows
              position={[0, -1.4, 0]}
              opacity={0.5}
              scale={10}
