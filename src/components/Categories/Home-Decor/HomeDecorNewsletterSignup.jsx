      ...
      <div className="max-w-3xl w-full text-center">
        ...
        <form className="flex flex-col sm:flex-row items-center gap-4 sm:gap-3">
          <input
            ...
            className="flex-1 px-4 py-3 rounded-lg text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-amber-600 w-full sm:w-auto"
            required
          />
          <button
            type="submit"
            className="bg-amber-600 hover:bg-amber-700 text-gray-900 font-semibold px-6 py-3 rounded-lg transition duration-300 w-full sm:w-auto"
          >
            Subscribe
          </button>
        </form>
