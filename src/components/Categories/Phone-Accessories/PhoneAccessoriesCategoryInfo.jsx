...
const PhoneAccessoriesCategoryInfo = () => {
  return (
    <section className="bg-white text-amber-600 py-12 px-6 sm:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-wide mb-6 text-amber-600 drop-shadow-lg">
          Premium Phone Accessories
        </h1>
        <p className="text-amber-500 max-w-3xl leading-relaxed text-lg sm:text-xl mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div className="bg-amber-950 bg-opacity-20 rounded-xl p-6 shadow-lg hover:bg-opacity-40 transition duration-300">
