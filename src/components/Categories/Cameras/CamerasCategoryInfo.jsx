      ...
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-xl transition">
            <FaCameraRetro className="text-yellow-400 text-4xl mb-3 mx-auto" />
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-xl transition">
            <FaVideo className="text-yellow-400 text-4xl mb-3 mx-auto" />
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-xl transition">
            <FaStar className="text-yellow-400 text-4xl mb-3 mx-auto" />
          ...
          <div className="bg-gray-800 p-6 rounded-xl shadow hover:shadow-xl transition">
            <FaShippingFast className="text-yellow-400 text-4xl mb-3 mx-auto" />
