...
const musicProducts = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1650542851431-dd5fd5f6b92e?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjY1fHxtdXNpY3xlbnwwfHwwfHx8MA%3D%3D",
    price: "$120",
    specs: ["Noise Cancelling", "20h Battery Life", "Built-in Mic"],
  },
  {
    id: 2,
    name: "Digital Piano Keyboard",
    image:
      "https://plus.unsplash.com/premium_photo-1682125511152-549a67b66c4a?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjY2fHxtdXNpY3xlbnwwfHwwfHx8MA%3D%3D",
    price: "$450",
    specs: ["88 Keys", "Weighted Keys", "Built-in Speakers"],
  },
  {
    id: 3,
    name: "Electric Guitar Starter Kit",
    image:
      "https://images.unsplash.com/photo-1597242105258-aae69ba3c61f?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjczfHxtdXNpY3xlbnwwfHwwfHx8MA%3D%3D",
    price: "$300",
    specs: ["Includes Amp", "6 Strings", "Beginner Friendly"],
  },
];

const MusicCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Music Products</h2>
                <button
...
export default MusicCompareBar;
