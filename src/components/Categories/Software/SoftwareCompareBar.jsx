...
const softwareProducts = [
  {
    id: 1,
    name: "Pro Editing Suite",
    image:
      "https://images.unsplash.com/photo-1604964432806-254d07c11f32?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZGV2ZWxvcGVyfGVufDB8fDB8fHww",
    price: "$199",
    specs: ["Supports 4K", "Multi-layer editing", "Cloud sync"],
  },
  {
    id: 2,
    name: "Secure Antivirus Plus",
    image:
      "https://plus.unsplash.com/premium_photo-1663023612721-e588768ef403?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8ZGV2ZWxvcGVyfGVufDB8fDB8fHww",
    price: "$59",
    specs: ["Real-time protection", "Automatic updates", "Multi-device"],
  },
  {
    id: 3,
    name: "Cloud Storage Pro",
    image:
      "https://images.unsplash.com/photo-1522252234503-e356532cafd5?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fGRldmVsb3BlcnxlbnwwfHwwfHx8MA%3D%3D",
    price: "$120",
    specs: ["1TB storage", "End-to-end encryption", "File versioning"],
  },
];

const SoftwareCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Software Products</h2>
                <button
...
export default SoftwareCompareBar;
