...
const FitnessProductGrid = () => {
  const [sortOption, setSortOption] = useState("");
const [visibleCount, setVisibleCount] = useState(9); // Initially show 9
const [products, setProducts] = useState(fitnessData.slice(0, 9));

const handleLoadMore = () => {
  const newCount = visibleCount + 9;
  setVisibleCount(newCount);
  setProducts(fitnessData.slice(0, newCount));
};
...
export default FitnessProductGrid;
