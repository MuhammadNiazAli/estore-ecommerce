...
const ClothingNewsletterSignup = () => {
    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-black mb-2">
          Stay Updated with Our Latest Clothing Deals
        </h2>
        <p className="text-black mb-6">
          Subscribe to our newsletter and never miss out on new arrivals and offers!
        </p>
        <form
...
export default ClothingNewsletterSignup;
