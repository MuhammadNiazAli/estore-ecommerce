...
const TravelNewsletterSignup = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Thanks for signing up, ${email}! Get ready for your next adventure with our travel tips and deals.`);
    setEmail("");
  };
    ...
    <section className="bg-white py-12 px-4">
      <div className="max-w-md mx-auto text-center">
        <h2 className="text-3xl font-bold text-black mb-2">
          Discover Travel Tips & Exclusive Deals
        </h2>
        <p className="text-black mb-6">
          Subscribe to our travel newsletter for expert advice, destination guides, and special offers!
        </p>
        <form
