...
const officeProducts = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1619596658767-f3bbb82b0dee?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDN8fHxlbnwwfHx8fHw%3D",
    price: "$120",
    specs: ["Adjustable Height", "Lumbar Support", "360° Swivel"],
  },
  {
    id: 2,
    name: "Standing Desk",
    image:
      "https://images.unsplash.com/photo-1694272604617-9c2ff92d5697?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDV8fHxlbnwwfHx8fHw%3D",
    price: "$350",
    specs: ["Electric Height Adjustment", "Sturdy Frame", "Eco-friendly Top"],
  },
  {
    id: 3,
    name: "LED Desk Lamp",
    image:
      "https://images.unsplash.com/photo-1593205460102-3de4714c3ff1?w=400&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDZ8fHxlbnwwfHx8fHw%3D",
    price: "$45",
    specs: ["Touch Control", "3 Brightness Levels", "USB Charging"],
  },
];

const OfficeCompareBar = () => {
          ...
          >
            ...
            >
              <header className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Compare Office Products</h2>
                <button
...
export default OfficeCompareBar;
