...
const AudioModel = ({ scale }) => {
  const groupRef = useRef();
  const { scene } = useGLTF("/models/boombox_2k.gltf"); // ✅ Your Audio Model
      ...
      <div className="mx-auto max-w-[1200px] px-4 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 space-y-6 text-center lg:text-left">
          <div className="inline-block bg-yellow-400 text-black px-4 py-1 rounded-full text-sm font-semibold">
            Premium Audio Gear 2025
          </div>

          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight tracking-tight">
            Experience <span className="text-yellow-400 underline decoration-yellow-300 decoration-4">Powerful Sound</span> Like Never Before
          </h1>

          <p className="text-gray-300 max-w-md mx-auto lg:mx-0 text-lg leading-relaxed">
            Discover next-level audio clarity with our cutting-edge boombox
            designed for music lovers and audiophiles alike.
          </p>

          <div className="bg-gray-800/60 p-4 rounded-xl inline-block">
            <p className="text-3xl font-bold text-yellow-400">$249</p>
