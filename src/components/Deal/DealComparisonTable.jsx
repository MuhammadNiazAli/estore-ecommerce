        ...
        {plans.map((plan, index) => (
          <article
            ...
            className={`
              ...
              ${
                plan.isBest
                  ? 'bg-gradient-to-br from-black via-gray-700 to-gray-900 border-black text-gray-900 shadow-xl scale-105 z-10'
                  : 'bg-white border-gray-200 text-gray-700 hover:shadow-2xl hover:scale-[1.02]'
              }
            `}
          >
            {plan.isBest && (
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-black px-4 py-1.5 rounded-full text-sm font-bold shadow-md select-none animate-pulse">
                 Recommended
              </div>
            )}
            ...
            <button
              ...
              className={`mt-10 w-full py-3 rounded-xl text-base font-semibold transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-offset-2
                ${
                  plan.isBest
                    ? 'bg-white text-black hover:bg-gray-500 focus:ring-black focus:ring-offset-white'
