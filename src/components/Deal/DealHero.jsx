...
const DealHero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full bg-white text-gray-900 overflow-hidden py-16 px-4 sm:px-6 md:px-10 xl:px-0 flex justify-center my-[-100px] mb-[-50px]"
    >
      {/* Background Image */}
      ...
      <div className="max-w-[1100px] w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
        ...
        <div className="text-center lg:text-left space-y-6 fade-in-up">
          ...
          <p className="text-gray-700 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 leading-relaxed">
        ...
        <div className="relative w-full h-[400px] sm:h-[460px] lg:h-[520px] rounded-3xl overflow-hidden shadow-2xl border-2 border-amber-600">
          ...
          {/* Feature Cards */}
          <div className="absolute left-4 right-4 bottom-3 sm:bottom-5 md:bottom-6 grid grid-cols-2 gap-3 p-3 sm:p-4 bg-white/10 backdrop-blur-md border border-gray-200/20 rounded-xl sm:rounded-2xl w-[90%] mx-auto max-w-sm">
