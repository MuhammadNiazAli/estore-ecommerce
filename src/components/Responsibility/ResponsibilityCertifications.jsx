    ...
    <section className="w-full bg-white flex justify-center px-4 py-14 sm:py-20 mb-0 my[-30px]">
      <div className="w-full max-w-[1000px]">
        ...
        <motion.h2
          ...
          className="text-center text-3xl sm:text-4xl font-extrabold text-black mb-12 select-none"
        >
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          {certifications.map((cert, index) => (
            <motion.article
              ...
              className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl hover:border-black transition-all duration-300 group cursor-default focus:outline-black focus:outline-2 focus:outline-offset-2"
              tabIndex={0}
              aria-label={`${cert.title}: ${cert.description}`}
              role="region"
            >
              <div className="flex items-center gap-5 mb-5">
                <div className="p-3 bg-white rounded-full border border-gray-200 group-hover:border-black transition-colors duration-300 flex items-center justify-center">
                  {cert.icon}
                </div>
