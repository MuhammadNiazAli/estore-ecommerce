...
const ResponsibilityTestimonials = () => {
  ...
  return (
    <section className="w-full bg-gray-900 py-16 flex flex-col items-center px-4">
      <motion.h2
        initial={{ opacity: 0, y: 25 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.7 }}
        className="text-yellow-400 text-4xl font-bold mb-12 text-center max-w-[1000px] select-none"
      >
      ...
      <div className="relative w-full max-w-[1000px]">
        ...
        <button
          ...
          className={`hidden sm:flex absolute top-1/2 left-0 transform -translate-y-1/2 rounded-full p-2 z-10 transition
            bg-gray-800/70 hover:bg-yellow-500 hover:text-gray-900
            ${!canScrollLeft ? 'opacity-30 cursor-not-allowed hover:bg-gray-800 hover:text-yellow-400' : ''}`}
        ...
        >
          {testimonials.map(({ id, name, role, photo, quote }) => (
            <motion.article
              ...
              className="min-w-[260px] sm:min-w-[280px] md:min-w-[300px] bg-gray-800/50 border border-gray-700 rounded-xl p-6 flex flex-col"
            ...
            >
              ...
              <p className="text-gray-300 text-sm flex-grow">{quote}</p>
            </motion.article>
          ))}
        </div>
        ...
        <button
          ...
          className={`hidden sm:flex absolute top-1/2 right-0 transform -translate-y-1/2 rounded-full p-2 z-10 transition
            bg-gray-800/70 hover:bg-yellow-500 hover:text-gray-900
            ${!canScrollRight ? 'opacity-30 cursor-not-allowed hover:bg-gray-800 hover:text-yellow-400' : ''}`}
