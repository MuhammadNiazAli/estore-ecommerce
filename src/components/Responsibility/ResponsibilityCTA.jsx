...
const ResponsibilityCTA = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1000px] bg-white/40 backdrop-blur-md border border-gray-200 rounded-2xl text-center px-5 sm:px-8 py-10 sm:py-14">
        {/* Heading */}
        <motion.h2
          ...
          className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 select-none px-2 sm:px-0"
        >
        ...
        <motion.p
          ...
          className="text-gray-700 max-w-xl mx-auto text-sm sm:text-base md:text-lg mb-8 leading-relaxed px-2 sm:px-0"
        >
