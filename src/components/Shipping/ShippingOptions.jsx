...
const ShippingOptions = () => {
  return (
    <section
      ...
      className="max-w-[1000px] mx-auto px-6 py-16 sm:py-24 text-gray-300"
    >
      <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-12 text-center drop-shadow-lg">
      ...
      <div className="grid gap-10 sm:grid-cols-2">
        {options.map(({ Icon, title, description }) => (
          <div
            key={title}
            className="flex items-start gap-6 bg-gray-900 rounded-2xl p-6 sm:p-8
          ...
          >
            <div
              className="flex-shrink-0 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16
                         ...
                         text-white drop-shadow-lg transition-transform duration-300 group-hover:scale-110"
            >
