      ...
      <div className="w-full max-w-[1000px] flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="w-full md:w-auto">
          <select
            ...
            className="bg-white border border-gray-200 rounded-lg px-4 py-2 text-gray-700 text-sm focus:outline-none focus:border-black w-full md:w-auto"
          >
        ...
        <div className="flex items-center gap-2 text-gray-700 text-sm">
          ...
          <input
            ...
            min="0"
            max="1000"
            className="accent-black w-32 sm:w-40"
          />
          <span>$1000</span>
        </div>
        ...
        {/* Clear Filters */}
        <button className="text-black hover:text-black font-semibold text-sm">
          Clear Filters
        </button>
      </div>
    </section>
