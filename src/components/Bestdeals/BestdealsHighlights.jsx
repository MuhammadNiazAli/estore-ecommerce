...
const highlights = [
  {
    id: 1,
    icon: <Truck className="w-10 h-10 sm:w-12 sm:h-12 text-black" />,
    title: 'Free Shipping',
    description: 'Enjoy free and fast shipping on all orders above $50.',
  },
  {
    id: 2,
    icon: <ShieldCheck className="w-10 h-10 sm:w-12 sm:h-12 text-black" />,
    title: 'Secure Shopping',
    description: 'Your transactions are protected with 256-bit SSL encryption.',
  },
  {
    id: 3,
    icon: <CreditCard className="w-10 h-10 sm:w-12 sm:h-12 text-black" />,
    title: 'Easy Payments',
    description: 'Multiple payment options including COD and EMIs available.',
  },
  {
    id: 4,
    icon: <Gift className="w-10 h-10 sm:w-12 sm:h-12 text-black" />,
...
const BestdealsHighlights = () => {
  return (
    <section
      ...
      className="bg-white text-gray-900 w-full flex justify-center py-12 px-4 sm:px-6"
    >
