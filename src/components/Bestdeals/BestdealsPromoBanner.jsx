...
const BestdealsPromoBanner = () => {
  return (
    <section className="bg-yellow-400 text-gray-900 w-full flex justify-center py-4 px-4 sm:px-6">
      <div className="max-w-[1000px] w-full flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a
          href="#shop-now"
          className="inline-block bg-gray-900 text-yellow-400 font-semibold rounded-lg px-6 py-3 text-center hover:bg-gray-800 transition duration-300 whitespace-nowrap flex-shrink-0"
