...
const steps = [
  {
    ...
    icon: <Search className="w-12 h-12 text-black" aria-hidden="true" />,
  },
  {
    title: 'Get Help Fast',
    description: 'Browse articles or start a chat with our support team.',
    icon: <MessageSquare className="w-12 h-12 text-black" aria-hidden="true" />,
  },
  {
    title: 'Issue Resolved',
    description: 'Follow simple steps and get your problem solved promptly.',
    icon: <CheckCircle className="w-12 h-12 text-black" aria-hidden="true" />,
  },
];
    ...
    >
      <div className="max-w-[1100px] w-full text-gray-900 text-center">
        <h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-black mb-16 tracking-tight"
        >
          How It Works
        </h2>
        ...
        >
          {steps.map((step, index) => (
            <article
              ...
              className="bg-white hover:bg-gray-500 rounded-2xl px-6 py-10 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-black focus:ring-offset-2"
            >
