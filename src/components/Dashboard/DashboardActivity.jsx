...
const DashboardActivity = () => {
  ...
  return (
    <section className="w-full bg-white flex justify-center px-4 py-10 min-h-[500px]">
      <div className="w-full max-w-[1000px]">
        ...
        >
          ...
          {!loading && !error && paginatedActivities.length === 0 && (
            <div className="text-gray-600 text-center py-6 select-none">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={`text-sm truncate ${isRead ? 'text-gray-700 line-through' : 'text-gray-900'}`}>
                      {activity.message}
                    </p>

                    <div className="flex items-center gap-2 mt-1 text-xs text-gray-600 select-text">
