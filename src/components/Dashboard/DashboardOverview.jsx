  ...
  'This Month': [
    {
      title: 'Total Sales',
      value: '$48,900',
      icon: <DollarSign className="text-amber-600 w-6 h-6" aria-hidden="true" />,
      change: '+12%',
    },
    {
      title: 'Orders',
      value: '1,320',
      icon: <ShoppingBag className="text-amber-600 w-6 h-6" aria-hidden="true" />,
      change: '+6.2%',
    },
    {
      title: 'Customers',
      value: '842',
      icon: <Users className="text-amber-600 w-6 h-6" aria-hidden="true" />,
      change: '+4.1%',
    },
    {
      title: 'Growth',
      value: '15.4%',
      icon: <TrendingUp className="text-amber-600 w-6 h-6" aria-hidden="true" />,
      change: '+2.8%',
    },
  ],
  'Last Month': [
    ...
    >
      <div className="w-full max-w-[1000px]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
          <div>
            <h2 className="text-2xl font-bold text-amber-600 select-none">Overview</h2>
          ...
          <div className="flex items-center gap-4">
                ...
                >
                  {periods.map((period) => (
                    <li
                      ...
                      className={`cursor-pointer px-3 py-2 hover:bg-amber-700 hover:text-gray-900 ${
                        period === selectedPeriod ? 'bg-amber-800 text-gray-900 font-semibold' : ''
                      }`}
                    >
                      {period}
                    </li>
            ...
            <button
              ...
              className="text-amber-600 hover:text-amber-500 transition disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-amber-600 rounded p-2"
            >
              {loading ? (
            ...
            ? Array.from({ length: 4 }).map((_, i) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="h-6 w-6 bg-amber-900 rounded"></div>
                  </div>
                  <div className="h-10 bg-amber-900 rounded w-3/4"></div>
