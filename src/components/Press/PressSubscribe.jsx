...
const PressSubscribe = () => {
  return (
    <div className="bg-white flex items-center justify-center px-4 py-16 sm:py-20 my-[-50px] mb-[-230px]">
      <div className="w-full max-w-[1000px] bg-white text-black p-6 sm:p-10 rounded-lg shadow-lg">
        ...
        <form className="flex flex-col sm:flex-row items-center max-w-md mx-auto gap-3 sm:gap-4">
          <input
            ...
            className="w-full px-4 py-3 rounded-md border border-black bg-white text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-black transition"
            required
          />
          <button
            type="submit"
            className="w-full sm:w-auto px-6 py-3 bg-black text-gray-900 font-semibold rounded-md hover:bg-black transition"
          >
            Subscribe
          </button>
        </form>
