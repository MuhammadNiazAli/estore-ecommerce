  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl">
        {/* Heading */}
        <h2 className="text-2xl xs:text-3xl sm:text-4xl font-extrabold text-black text-center mb-5">
          Get in Touch
        </h2>
        ...
        >
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-5">
            <input
              ...
              required
              className="w-full sm:w-1/2 px-4 py-3 rounded bg-white border border-gray-200 text-gray-900 focus:outline-none focus:ring-2 focus:ring-black"
            />
            <input
              type="email"
              name="user_email"
          ...
          <textarea
            ...
            required
            className="w-full px-4 py-3 rounded bg-white border border-gray-200 text-gray-900 resize-none focus:outline-none focus:ring-2 focus:ring-black"
          />
          <button
            type="submit"
            className="w-full sm:w-auto bg-black text-gray-900 font-semibold py-3 px-6 rounded-full hover:bg-black transition duration-300 shadow-md"
          >
            Send Message
          </button>
        </form>
        ...
        <div className="mt-10 sm:mt-12 space-y-4 text-center text-sm sm:text-base text-gray-600 px-2">
          <p className="flex flex-wrap justify-center items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              className="underline hover:text-black transition break-all"
            >
              contact@example.com
            </a>
          </p>
