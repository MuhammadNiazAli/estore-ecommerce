...
const AboutTeam = () => {
  return (
    <section
      className="bg-white text-gray-800 py-20 px-4 sm:px-6 lg:px-8 flex justify-center"
    ...
    >
      <div className="w-full max-w-3xl text-center">
        ...
        {/* Developer Card */}
        <div className="bg-white rounded-2xl px-6 py-10 shadow-xl flex flex-col items-center transition ">
