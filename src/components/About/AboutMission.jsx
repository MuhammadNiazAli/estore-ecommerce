...
const AboutMission = () => {
  return (
    <section
      className="bg-gray-900 text-gray-100 py-20 px-4 sm:px-6 lg:px-8 flex justify-center my-[-80px]"
      aria-label="Our mission and future plans"
    >
      <div className="w-full max-w-5xl text-center">
        {/* Mission Heading */}
        <h2 className="text-3xl sm:text-4xl font-extrabold text-yellow-400 mb-6 leading-tight">
          Our Mission
        </h2>

        {/* Mission Description */}
        <p className="text-base sm:text-lg md:text-xl text-gray-300 leading-relaxed mb-14 max-w-3xl mx-auto px-2">
        ...
        {/* What’s Next Section */}
        <div className="bg-gray-900 border border-gray-900 rounded-2xl p-6 sm:p-8 shadow-xl text-left">
          <h3 className="text-2xl sm:text-3xl font-bold text-yellow-300 text-center mb-10">
            What’s Next for Our eStore Project?
          </h3>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 text-gray-200">
            {/* Backend Integration */}
            <div className="flex items-start gap-4">
              <FaServer className="text-yellow-400 text-2xl sm:text-3xl shrink-0" />
              <div>
            ...
            {/* Future 3D Project */}
            <div className="flex items-start gap-4">
              <FaCube className="text-yellow-400 text-2xl sm:text-3xl shrink-0" />
              <div>
            ...
            {/* AI-Powered Growth */}
            <div className="flex items-start gap-4">
              <FaRocket className="text-yellow-400 text-2xl sm:text-3xl shrink-0" />
              <div>
