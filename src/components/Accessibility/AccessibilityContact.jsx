        ...
        >
          <label htmlFor="name" className="font-semibold text-lg">
            ...
            <input
              ...
              className="mt-1 w-full rounded-md bg-gray-800 border border-yellow-400 px-3 py-2 text-yellow-300 placeholder-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition"
            />
          </label>
          ...
          <button
            type="submit"
            className="self-center bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-3 px-8 rounded-md shadow-lg transition"
            aria-live="polite"
