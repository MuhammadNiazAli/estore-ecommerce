      ...
      <div className="max-w-[1000px] w-full text-black">
        ...
        >
                ...
                >
                  <svg
                    ...
                    className={`w-10 h-10 cursor-pointer transition-colors duration-200 ${
                      (hoverRating || rating) >= star ? 'text-black' : 'text-black'
                    }`}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                    aria-hidden="true"
          ...
          <button
            type="submit"
            disabled={submitted}
            className="self-center bg-black hover:bg-black text-gray-900 font-bold py-3 px-8 rounded-md shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
            aria-live="polite"
          >
