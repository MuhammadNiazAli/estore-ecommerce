...
const assistiveTechs = [
  {
    icon: <MonitorSpeaker className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
    title: 'Screen Reader Compatibility',
    description:
      'We support major screen readers like NVDA, JAWS, and VoiceOver with proper ARIA labeling and semantic HTML structure.',
  },
  {
    icon: <Mic className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
  ...
  {
    icon: <MousePointerClick className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
  ...
  {
    icon: <Eye className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
  ...
  {
    icon: <ScreenShare className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
  ...
  {
    icon: <Smartphone className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
...
const AssistiveTechSupport = () => {
  return (
    <section className="w-full bg-gray-900 py-16 px-4 sm:px-6 lg:px-8 text-white mb-[-30px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
          {assistiveTechs.map((tech, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-950 border border-gray-800 p-6 rounded-xl shadow-md hover:shadow-gray-950/80 hover:border-gray-950 transition-shadow duration-300 cursor-default"
              role="region"
