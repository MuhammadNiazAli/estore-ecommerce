...
const ComplianceStandards = () => {
  return (
    <section className="w-full bg-gray-900 text-white py-16 px-4 mb-[-50px] my-10">
        ...
        <div className="grid gap-6 sm:grid-cols-2 text-left">
          {standards.map((standard, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-950 border border-gray-800 rounded-xl p-6 shadow-md transition-shadow duration-500 hover:shadow-gray-950/80 hover:border-gray-950 cursor-default"
            >
              <div className="flex items-center space-x-3 mb-3">
                {standard.icon}
                <h3 className="text-lg font-semibold text-yellow-200">{standard.title}</h3>
              </div>
