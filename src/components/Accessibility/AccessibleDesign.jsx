...
const designTips = [
  {
    icon: <Contrast className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
  ...
  {
    icon: <Keyboard className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
  ...
  {
    icon: <Accessibility className="w-7 h-7 text-yellow-400" aria-hidden="true" />,
...
const AccessibleDesign = () => {
  return (
    <section className="w-full bg-gray-900 py-16 px-4 sm:px-6 lg:px-8 text-white my-[-60px] mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-left">
          {designTips.map((tip, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-950 border border-gray-800 p-6 rounded-xl shadow-lg hover:shadow-gray-950/80 transition-shadow duration-300 cursor-default"
              role="region"
