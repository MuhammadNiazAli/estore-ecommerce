...
const reasons = [
  ...
  {
    icon: <Truck className="text-amber-600" size={28} aria-hidden="true" />,
    title: 'Late Delivery',
    description: 'The delivery took longer than expected or promised.',
  },
  {
    icon: <AlertCircle className="text-amber-600" size={28} aria-hidden="true" />,
    title: 'Damaged Item',
    description: 'The product arrived damaged or defective.',
  },
  {
    icon: <Slash className="text-amber-600" size={28} aria-hidden="true" />,
    title: 'Changed Mind',
    description: 'You decided you no longer want the product.',
  },
  {
    icon: <XCircle className="text-amber-600" size={28} aria-hidden="true" />,
    title: 'Incorrect Size or Fit',
    description: 'The item did not fit as expected.',
  },
  {
    icon: <Smile className="text-amber-600" size={28} aria-hidden="true" />,
