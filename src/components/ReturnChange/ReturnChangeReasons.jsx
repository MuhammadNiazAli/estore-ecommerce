...
const reasons = [
  {
    icon: <Package className="text-yellow-400" size={28} aria-hidden="true" />,
    title: 'Wrong Item Delivered',
    description: 'Received a different product than what you ordered.',
  },
  {
    icon: <Truck className="text-yellow-400" size={28} aria-hidden="true" />,
    title: 'Late Delivery',
    description: 'The delivery took longer than expected or promised.',
  },
  {
    icon: <AlertCircle className="text-yellow-400" size={28} aria-hidden="true" />,
    title: 'Damaged Item',
    description: 'The product arrived damaged or defective.',
  },
  {
    icon: <Slash className="text-yellow-400" size={28} aria-hidden="true" />,
    title: 'Changed Mind',
    description: 'You decided you no longer want the product.',
  },
  {
    icon: <XCircle className="text-yellow-400" size={28} aria-hidden="true" />,
    title: 'Incorrect Size or Fit',
    description: 'The item did not fit as expected.',
  },
  {
    icon: <Smile className="text-yellow-400" size={28} aria-hidden="true" />,
    ...
    >
      <div className="max-w-[1000px] w-full text-center">
        <h2
          ...
          className="text-yellow-400 text-4xl font-bold mb-10"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-left">
          {reasons.map(({ icon, title, description }, idx) => (
            <div
              ...
              className="bg-gray-800 rounded-xl p-6 shadow-md hover:bg-gray-700 transition cursor-pointer focus:outline-yellow-400 focus:ring-2 focus:ring-yellow-400 focus:ring-offset-1"
            >
              <div className="mb-4">{icon}</div>
              <h3 className="text-yellow-300 font-semibold text-xl mb-2">{title}</h3>
