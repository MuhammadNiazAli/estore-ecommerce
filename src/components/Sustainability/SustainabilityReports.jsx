...
const SustainabilityReports = () => {
  return (
    <section
      ...
      className="bg-white text-black px-4 sm:px-6 lg:px-8 py-16 mb-[-130px]"
    >
      <div className="max-w-4xl mx-auto">
        <h2
          id="sustainability-reports-title"
          className="text-3xl sm:text-4xl font-extrabold text-black mb-12 text-center select-none"
        >
          ...
          {reports.map(({ title, date, url }, i) => (
            <li
              ...
              className="
                ...
                bg-black/10 rounded-xl p-5 shadow-lg
                hover:bg-black/25 transition-colors duration-300
                focus-within:ring-4 focus-within:ring-black focus-within:ring-opacity-70
                outline-none
              "
            >
              <div className="mb-3 sm:mb-0">
                <h3 className="text-black text-lg font-semibold">{title}</h3>
                <p className="text-black text-sm mt-1 tracking-wide">{date}</p>
              </div>
              <a
                href={url}
                target="_blank"
                ...
                className="
                  ...
                  focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 focus:ring-offset-gray-900 rounded
                  select-none
                "
