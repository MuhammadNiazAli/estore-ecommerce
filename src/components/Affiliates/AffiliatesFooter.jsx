...
const AffiliatesFooter = () => {
  return (
    <footer className="bg-white mb-[-150px] text-black py-12 px-4">
      <div className="max-w-[1000px] mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <address className="not-italic space-y-2 text-sm text-black leading-relaxed">
      ...
      <div className="max-w-[1000px] mx-auto mt-10 border-t border-black pt-6 text-center text-sm text-black tracking-wide">
