...
const initialBenefits = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-amber-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
const AffiliatesBenefits = () => {
  ...
  return (
    <section className="bg-white text-amber-600 py-14 px-4 sm:px-6 lg:px-8">
        ...
        {visibleCount < initialBenefits.length && (
          <div className="text-center mt-8">
            <button
              ...
              className="inline-flex items-center gap-2 bg-amber-700 text-gray-900 font-semibold px-6 py-2 rounded-full hover:bg-amber-600 transition-all focus:outline-none focus:ring-2 focus:ring-amber-500 disabled:opacity-50"
              disabled={loading}
            >
              {loading ? (
                <>
