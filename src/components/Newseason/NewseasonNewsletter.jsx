      ...
      <div className="max-w-[800px] mx-auto text-center">
        ...
        <form className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <input
            ...
            className="w-full sm:w-[60%] px-4 py-3 rounded-lg bg-gray-800 text-yellow-200 placeholder-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-400"
          />
          <button
            type="submit"
            className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-3 px-8 rounded-lg shadow-lg transition-all duration-300 w-full sm:w-auto"
          >
            Subscribe
          </button>
        </form>
