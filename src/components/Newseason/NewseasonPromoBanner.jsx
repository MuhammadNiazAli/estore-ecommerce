...
const NewseasonPromoBanner = () => {
  return (
    <section className="relative bg-gray-900">
      ...
      ></div>
      <div className="absolute inset-0 bg-gray-950/40 bg-opacity-60"></div>

      {/* Content */}
      <div className="relative max-w-[1000px] mx-auto px-6 py-20 text-center z-10">
        <h2 className="text-yellow-400 text-4xl md:text-5xl font-extrabold mb-4">
          New Season Exclusive Sale
        </h2>
        <p className="text-yellow-200 text-lg md:text-xl max-w-2xl mx-auto mb-8">
          Upgrade your wardrobe with premium styles at unbeatable prices. Limited-time offer—don’t miss out!
        </p>
        <button
          type="button"
          className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold py-3 px-10 rounded-lg shadow-lg transition-all duration-300"
        >
          Shop Now
        </button>
      </div>
