  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="mt-10 text-xl font-semibold tracking-wide text-yellow-300">
        ...
        <ul className="list-disc list-inside mt-2 max-w-full text-yellow-300 sm:text-base space-y-2">
          <li>
