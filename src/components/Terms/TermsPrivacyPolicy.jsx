  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-6 text-amber-500 max-w-full leading-relaxed sm:text-lg">
        ...
        <h3 className="mt-10 text-xl font-semibold tracking-wide text-amber-500">
        ...
        <ul className="list-disc list-inside mt-2 max-w-full text-amber-500 sm:text-base space-y-2">
          <li>
