...
const TermsHero = () => {
  return (
    <section
      ...
      className="bg-white text-black min-h-screen py-12 my-[-50px]"
    >
      <div className="max-w-3xl mx-auto px-6 sm:px-8">
        ...
        <section className="mt-10 space-y-8 text-black text-sm sm:text-base leading-relaxed">
          <article>
        ...
        <p className="mt-12 text-black text-sm sm:text-base">
