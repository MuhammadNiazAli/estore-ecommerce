...
const features = [
  {
    icon: <FiMapPin className="text-yellow-400 text-lg" />,
    label: 'Save Multiple Delivery Locations',
  },
  {
    icon: <FiHome className="text-yellow-400 text-lg" />,
    label: 'Set Your Default Address',
  },
  {
    icon: <FiCheckCircle className="text-yellow-400 text-lg" />,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            ...
            aria-hidden="true"
          >
            <FaMapMarkedAlt className="text-yellow-400 text-[5.5rem]" />
          </div>
        </div>
      </div>
