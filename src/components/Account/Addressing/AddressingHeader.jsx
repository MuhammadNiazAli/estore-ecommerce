...
const AddressingHeader = ({ onBack }) => {
  return (
    <header className="w-full max-w-[1200px] mx-auto px-6 py-6 flex items-center gap-6 bg-gradient-to-r from-white via-white to-white rounded-3xl shadow-md text-gray-900">
      {onBack && (
        <button
          onClick={onBack}
          aria-label="Go back"
