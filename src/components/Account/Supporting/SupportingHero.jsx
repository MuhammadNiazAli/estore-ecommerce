...
const supportFeatures = [
  ...
  {
    icon: <FiLifeBuoy className="text-amber-600 text-lg" />,
    label: '24/7 Support',
  },
  {
    icon: <FiMessageSquare className="text-amber-600 text-lg" />,
    label: 'Live Chat',
  },
];
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="max-w-md mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
          ...
          {/* Features List */}
          <ul className="flex flex-col sm:flex-row justify-start gap-6 text-sm text-amber-600 font-semibold max-w-xs mx-auto lg:mx-0">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 pt-5">
            <button
              type="button"
              className="px-8 py-3 bg-amber-700 text-amber-950 font-semibold rounded-full shadow-md
            ...
            <button
              type="button"
              className="px-8 py-3 border-2 border-amber-600 text-amber-600 font-semibold rounded-full
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            className="w-52 h-52 sm:w-64 sm:h-64 rounded-3xl bg-amber-900 border-8 border-amber-600
              shadow-[0_15px_40px_rgba(202,138,4,0.6)] flex items-center justify-center
              animate-pulse"
            aria-hidden="true"
          >
            <FaHandsHelping className="text-amber-600 text-[6rem]" />
          </div>
        </div>
      </div>
