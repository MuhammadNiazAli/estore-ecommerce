...
const supportFeatures = [
  ...
  {
    icon: <FiLifeBuoy className="text-black text-lg" />,
    label: '24/7 Support',
  },
  {
    icon: <FiMessageSquare className="text-black text-lg" />,
    label: 'Live Chat',
  },
];
  ...
  return (
    <section
      ...
      className="w-full max-w-[900px] mx-auto px-6 py-14 lg:py-20 my-[-30px] mb-8
        bg-white
        text-black rounded-3xl shadow-2xl overflow-hidden relative"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="max-w-md mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
          ...
          <p className="text-black text-base leading-relaxed max-w-sm mx-auto lg:mx-0">
            Access all the assistance and resources you need for smooth and worry-free experiences — expert support just a click away.
          </p>

          {/* Features List */}
          <ul className="flex flex-col sm:flex-row justify-start gap-6 text-sm text-black font-semibold max-w-xs mx-auto lg:mx-0">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 pt-5">
            <button
              type="button"
              className="px-8 py-3 bg-black text-black font-semibold rounded-full shadow-md
            ...
            <button
              type="button"
              className="px-8 py-3 border-2 border-black text-black font-semibold rounded-full
                hover:bg-black hover:text-black transition-all duration-300
                focus:outline-none focus:ring-4 focus:ring-black focus:ring-offset-2"
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            className="w-52 h-52 sm:w-64 sm:h-64 rounded-3xl bg-black border-8 border-black
              shadow-[0_15px_40px_rgba(202,138,4,0.6)] flex items-center justify-center
              animate-pulse"
            aria-hidden="true"
          >
            <FaHandsHelping className="text-black text-[6rem]" />
          </div>
        </div>
      </div>

      {/* Decorative Floating Icon */}
      <div className="absolute top-8 left-8 hidden lg:block text-black text-5xl opacity-10 pointer-events-none select-none">
        <FaHandsHelping />
      </div>
    </section>
  );
