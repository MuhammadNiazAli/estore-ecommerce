...
const securityFeatures = [
  {
    icon: <FiShield className="text-black text-xs" />,
    label: <span className="text-black text-xs">Advanced Encryption Protection</span>,
  },
  {
    icon: <FiLock className="text-black text-xs" />,
    label: <span className="text-black text-xs">Password & 2FA Control</span>,
  },
  {
    icon: <FiAlertTriangle className="text-black text-xs" />,
    label: <span className="text-black text-xs">Suspicious Login Alerts</span>,
  },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            ...
            aria-hidden="true"
          >
            <FaFingerprint className="text-black text-[5.5rem]" />
          </div>
        </div>
      </div>
