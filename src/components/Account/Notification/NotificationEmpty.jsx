...
const NotificationEmpty = () => {
  ...
  return (
    <motion.section
      ...
      className="w-full max-w-md mx-auto px-6 py-16 text-center bg-gradient-to-br from-white via-white to-white text-gray-900 rounded-3xl shadow-2xl"
    >
      <div className="flex justify-center mb-6">
        <motion.div
          whileHover={{ rotate: 5 }}
          className="w-24 h-24 rounded-2xl bg-white border-4 border-gray-200 shadow-inner flex items-center justify-center"
        >
