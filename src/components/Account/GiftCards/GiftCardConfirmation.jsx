...
const GiftCardConfirmation = ({
  ...
  return (
    <section
      ...
      className={`max-w-[900px] mx-auto bg-gray-900
        text-white rounded-3xl shadow-2xl p-10 flex flex-col items-center space-y-8
    ...
    >
      ...
      <p className="text-yellow-200 max-w-md text-center leading-relaxed select-text">
        Your gift card has been successfully processed. A confirmation email has been sent to your inbox.
      </p>

      <div className="bg-yellow-800 rounded-xl p-6 w-full max-w-md shadow-inner">
        <h3
        ...
        <ul className="text-yellow-200 space-y-2 text-sm sm:text-base select-text">
          <li>
      ...
      <div className="flex flex-col sm:flex-row gap-6 w-full max-w-md">
        <button
          ...
          className="flex-1 px-8 py-3 bg-yellow-400 text-black font-semibold rounded-full shadow-md
            hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-300 focus:ring-offset-2
        ...
        <button
          type="button"
          onClick={onGoHome}
          className="flex-1 flex items-center justify-center gap-2 px-8 py-3 border border-yellow-400
            text-yellow-400 font-semibold rounded-full hover:bg-yellow-700 hover:text-white
