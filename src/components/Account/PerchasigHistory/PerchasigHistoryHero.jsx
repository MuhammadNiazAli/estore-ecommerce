        ...
        <div className="max-w-md mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-6 pt-5">
            <button
              type="button"
              className="
                px-8 py-3 bg-black text-black font-semibold rounded-full shadow-md
            ...
            <button
              type="button"
              className="
                px-8 py-3 border-2 border-black text-black font-semibold rounded-full
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            className="
              ...
              bg-black border-8 border-black
            ...
            aria-hidden="true"
          >
            <FaShoppingBag className="text-black text-[6rem]" />
          </div>
        </div>
      </div>
