...
const shippingFeatures = [
  {
    icon: <FaPaperPlane className="text-black text-lg" />,
    label: 'Fast Shipping Options',
  },
  {
    icon: <FaShip className="text-black text-lg" />,
    label: 'Reliable Delivery Partners',
  },
  {
    icon: <FaMapMarkerAlt className="text-black text-lg" />,
...
const viewOptionsContent = (
  <div className="text-left text-sm text-gray-700 space-y-3">
    <h3 className="text-xl font-semibold text-black">Our Shipping Options</h3>
...
const contactSupportContent = (
  <div className="text-left text-sm text-gray-700 space-y-3">
    <h3 className="text-xl font-semibold text-black">Contact Shipping Support</h3>
    <p>
    ...
    <p className="pt-2 text-xs text-gray-600">
      Call us at <a href="tel:+18001234567" className="underline text-black">1-800-123-4567</a> or email <a href="mailto:shipping@yourstore.com" className="underline text-black">shipping@yourstore.com</a>.
    </p>
  </div>
);
