...
const trackOrderFeatures = [
  {
    icon: <FaMapMarkedAlt className="text-yellow-400 text-lg" />,
  ...
  {
    icon: <FaSearchLocation className="text-yellow-400 text-lg" />,
...
const trackNowContent = (
  <div className="text-left text-sm text-gray-300 space-y-3">
    <h3 className="text-xl font-semibold text-yellow-400">Track Your Order Now</h3>
    <p>
...
const learnMoreContent = (
  <div className="text-left text-sm text-gray-300 space-y-3">
    <h3 className="text-xl font-semibold text-yellow-400">Learn More About Tracking</h3>
    <p>
