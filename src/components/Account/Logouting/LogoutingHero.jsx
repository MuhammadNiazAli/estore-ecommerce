    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="max-w-md mx-auto lg:mx-0 space-y-6 text-center lg:text-left">
          ...
          <p className="text-amber-500 text-base sm:text-lg leading-relaxed max-w-sm mx-auto lg:mx-0">
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            ...
            aria-hidden="true"
          >
            <FaSignOutAlt className="text-amber-600 text-[6rem]" />
          </div>
        </div>
      </div>

      {/* Decorative Floating Icon */}
      <div className="absolute top-6 left-6 hidden lg:block text-amber-600 text-5xl opacity-15 pointer-events-none select-none">
        <FaSignOutAlt />
      </div>
    </section>
  );
