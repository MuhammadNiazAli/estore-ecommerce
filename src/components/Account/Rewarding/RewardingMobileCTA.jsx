...
export default function RewardingMobileCTA() {
  return (
    <nav
      className="fixed bottom-0 left-0 w-full z-50 bg-gray-900 border-t border-yellow-400 shadow-[0_-2px_10px_rgba(0,0,0,0.3)] px-4 py-2 flex justify-around items-center sm:hidden"
      aria-label="Mobile reward quick actions"
    >
      {/* Points Button */}
      <button
        type="button"
        className="flex flex-col items-center text-yellow-300 text-xs font-semibold hover:text-yellow-200 transition-colors duration-200"
