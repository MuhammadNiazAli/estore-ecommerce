...
const steps = [
  {
    icon: <FaShoppingBag className="text-yellow-400 text-3xl" />,
    title: '1. Shop & Earn',
  ...
  {
    icon: <FaGift className="text-yellow-400 text-3xl" />,
...
function HowItWorksStep({ icon, title, description }) {
  return (
    <article
      className="bg-gray-800 border border-gray-700 rounded-xl px-6 py-8 shadow-md transition-all duration-300 hover:border-yellow-400"
      role="region"
      aria-label={title}
      tabIndex={0}
    >
      <div className="mb-4 flex justify-center">{icon}</div>
      <h3 className="text-yellow-300 text-lg font-semibold mb-2">{title}</h3>
