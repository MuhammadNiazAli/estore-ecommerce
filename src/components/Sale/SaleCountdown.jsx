  ...
  return (
    <section className="w-full flex justify-center px-4 my-[-30px]">
      <div className="max-w-[1000px] w-full bg-white rounded-2xl text-center py-8 md:py-12 px-4 sm:px-6 lg:px-8 shadow-lg border border-gray-200">
        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-black mb-3 md:mb-4 leading-tight">
          ...
          <>
            ...
            <div className="flex justify-center flex-wrap gap-3 sm:gap-4 md:gap-8">
              {[
                ...
                <div
                  key={index}
                  className="flex flex-col items-center bg-white text-black rounded-xl px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4 min-w-[65px] sm:min-w-[80px] md:min-w-[100px] shadow-md"
                >
