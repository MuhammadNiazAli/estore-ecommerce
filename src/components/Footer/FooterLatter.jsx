          ...
          {!submitted ? (
            ...
            >
              <input
                ...
                required
                className="w-full bg-white sm:flex-1 px-5 py-3 rounded-lg focus:outline-none focus:ring-4 focus:ring-black text-black placeholder-gray-500 shadow-md transition"
              />
              <button
                type="submit"
                className="bg-black hover:bg-black cursor-pointer active:bg-black text-gray-900 font-semibold px-8 py-3 rounded-lg shadow-lg transition focus:outline-none focus:ring-4 focus:ring-black flex items-center justify-center gap-2"
              >
                Subscribe
            ...
            <p className="text-black font-semibold mt-6 text-lg flex items-center justify-center gap-2 animate-fadeIn">
              <FiCheckCircle size={24} /> Thank you for subscribing!
            </p>
          )}
        </section>

        <section className="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-10 text-center text-black">
          <div className="space-y-3">
            <FiStar className="mx-auto text-black" size={40} />
          ...
          <div className="space-y-3">
            <FiShield className="mx-auto text-black" size={40} />
          ...
          <div className="space-y-3">
            <FiCheckCircle className="mx-auto text-black" size={40} />
