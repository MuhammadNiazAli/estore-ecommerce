...
const FaqsHero = () => {
  ...
  return (
    <section
      ...
      className="relative text-yellow-400 overflow-hidden mb-10 bg-gray-900 md:bg-transparent my-[-30px]"
    >
 ...
 <div className="hidden md:block absolute inset-0 bg-[linear-gradient(135deg,#111214,#111214,#0D0E10,#08090B)] backdrop-blur-sm"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 py-16 flex flex-col md:flex-row items-center md:items-start gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 leading-tight text-yellow-400">
            Frequently Asked Questions
          </h1>
          <p className="text-yellow-300 text-lg sm:text-xl leading-relaxed mb-8">
          ...
          >
            <input
              ...
              className="
                ...
                bg-black/40 md:bg-black/40 border border-yellow-500
                text-yellow-300 placeholder-yellow-500 
          ...
          <div className="block sm:hidden mt-8 flex flex-col items-center gap-3">
            <FiHelpCircle className="text-yellow-400 text-5xl animate-bounce" />
            <button
              type="button"
              className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold py-3 px-8 rounded-full shadow-lg transition duration-300"
