    ...
    >
      <div className="max-w-[1000px] w-full text-center space-y-6">
        ...
        >
          ...
          >
            <Cookie className="w-6 h-6 mt-1 text-yellow-400 shrink-0" />
            <div>
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <Timer className="w-6 h-6 mt-1 text-yellow-400 shrink-0" />
            <div>
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <Info className="w-6 h-6 mt-1 text-yellow-400 shrink-0" />
            <div>
