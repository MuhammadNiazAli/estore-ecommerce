...
const PrivacyHero = () => {
  return (
    <section
      className="bg-gray-900 text-yellow-400 w-full flex justify-center items-center px-4 sm:px-6 lg:px-8 my-[-100px]"
    ...
    >
      <div className="max-w-[1000px] w-full text-center space-y-6">
        {/* Heading */}
        <motion.h1
          className="text-2xl sm:text-4xl lg:text-5xl font-bold leading-tight text-yellow-400 px-2 sm:px-0"
        ...
        {/* Description */}
        <motion.p
          className="text-sm sm:text-base lg:text-lg text-yellow-300 max-w-3xl mx-auto px-2 sm:px-0"
        ...
        >
          ...
          >
            <ShieldCheck className="w-6 h-6 sm:w-7 sm:h-7 text-yellow-400 shrink-0" />
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <Lock className="w-6 h-6 sm:w-7 sm:h-7 text-yellow-400 shrink-0" />
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <EyeOff className="w-6 h-6 sm:w-7 sm:h-7 text-yellow-400 shrink-0" />
