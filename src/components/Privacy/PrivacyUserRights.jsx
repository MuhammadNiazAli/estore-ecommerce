          ...
          {rights.map(({ icon, title, description }, index) => (
            <div key={index} className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-black text-xs sm:text-sm md:text-base leading-relaxed">{description}</p>
              </div>
            </div>
          ))}
        </div>

        <p className="text-black max-w-2xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed pt-4">
          ...
          <a
            ...
            className="underline hover:text-black transition-colors break-words"
          >
