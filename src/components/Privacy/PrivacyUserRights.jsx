...
const PrivacyUserRights = () => {
  ...
  return (
    <section
      ...
      className="bg-gray-900 text-yellow-400 w-full flex justify-center py-16 px-4 sm:px-6 lg:px-8"
    >
      <div className="max-w-[1000px] w-full text-center space-y-8">
        ...
        <p className="text-yellow-300 max-w-3xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed">
          ...
          {rights.map(({ icon, title, description }, index) => (
            <div key={index} className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-yellow-300 text-xs sm:text-sm md:text-base leading-relaxed">{description}</p>
              </div>
            </div>
          ))}
        </div>

        <p className="text-yellow-300 max-w-2xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed pt-4">
          ...
          <a
            ...
            className="underline hover:text-yellow-500 transition-colors break-words"
          >
