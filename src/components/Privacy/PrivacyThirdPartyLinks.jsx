  ...
  return (
    ...
    >
      <div className="max-w-[1000px] w-full text-center space-y-6">
        ...
        <p className="text-amber-500 text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
        ...
        <p className="text-amber-500 text-sm sm:text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
          ...
          <ExternalLink className="inline w-4 h-4 text-amber-600 align-baseline" />.
        </p>
      </div>
    </section>
  );
