...
const PrivacyContact = () => {
  return (
    <section
      className="bg-white text-black w-full flex justify-center items-center px-4 sm:px-6 lg:px-8"
    ...
    >
      <div className="max-w-[1000px] w-full text-center space-y-6">
        ...
        {/* Description */}
        <motion.p
          className="text-black max-w-2xl mx-auto text-sm sm:text-base lg:text-lg px-2 sm:px-0"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <Mail className="w-6 h-6 mt-1 text-black shrink-0" />
            <div>
              <p className="font-semibold text-sm sm:text-base">Email</p>
              <a
                href="mailto:privacy@yourdomain.com"
                className="text-black text-sm sm:text-base hover:underline break-all"
              >
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
          >
            <Phone className="w-6 h-6 mt-1 text-black shrink-0" />
            <div>
              <p className="font-semibold text-sm sm:text-base">Phone</p>
              <p className="text-black text-sm sm:text-base">+1 (800) 123-4567</p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
          >
            <MapPin className="w-6 h-6 mt-1 text-black shrink-0" />
            <div>
