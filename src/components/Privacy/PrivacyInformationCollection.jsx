  ...
  return (
    ...
    >
      <div className="w-full max-w-[1000px] text-center space-y-8">
        ...
        <motion.p
          className="text-yellow-300 text-base sm:text-lg md:text-xl max-w-3xl mx-auto px-2 sm:px-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            <User className="w-6 h-6 mt-1 flex-shrink-0 text-yellow-400" />
            <div>
              <p className="font-semibold text-base md:text-lg">Personal Information</p>
              <p className="text-yellow-300 text-sm md:text-base leading-relaxed">
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <Mail className="w-6 h-6 mt-1 flex-shrink-0 text-yellow-400" />
            <div>
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <MonitorSmartphone className="w-6 h-6 mt-1 flex-shrink-0 text-yellow-400" />
            <div>
          ...
          <motion.div
            ...
            variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0 } }}
          >
            <Globe2 className="w-6 h-6 mt-1 flex-shrink-0 text-yellow-400" />
            <div>
        ...
        <motion.p
          className="pt-8 text-sm md:text-base text-yellow-400 max-w-2xl mx-auto px-2 leading-relaxed"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
