      ...
      <div className="max-w-[1000px] w-full text-center space-y-6">
        ...
        <div className="grid sm:grid-cols-3 gap-6 text-left pt-6">
          <div className="flex items-start gap-4">
            <Settings className="w-6 h-6 mt-1 text-yellow-400" />
            <div>
          ...
          <div className="flex items-start gap-4">
            <ShieldCheck className="w-6 h-6 mt-1 text-yellow-400" />
            <div>
          ...
          <div className="flex items-start gap-4">
            <Zap className="w-6 h-6 mt-1 text-yellow-400" />
            <div>
        ...
        <p className="pt-8 text-yellow-300 max-w-2xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed">
