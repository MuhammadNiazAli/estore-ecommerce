      ...
      <div className="max-w-[1000px] w-full text-center space-y-6">
        ...
        <div className="grid sm:grid-cols-3 gap-6 text-left pt-6">
          <div className="flex items-start gap-4">
            <Settings className="w-6 h-6 mt-1 text-amber-600" />
            <div>
              <p className="font-semibold text-sm sm:text-base md:text-lg">Service Delivery</p>
              <p className="text-amber-500 text-xs sm:text-sm md:text-base">
          ...
          <div className="flex items-start gap-4">
            <ShieldCheck className="w-6 h-6 mt-1 text-amber-600" />
            <div>
          ...
          <div className="flex items-start gap-4">
            <Zap className="w-6 h-6 mt-1 text-amber-600" />
            <div>
        ...
        <p className="pt-8 text-amber-500 max-w-2xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed">
