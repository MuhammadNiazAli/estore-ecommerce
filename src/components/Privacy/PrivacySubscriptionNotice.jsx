...
const PrivacySubscriptionNotice = () => {
  return (
    <section
      ...
      className="bg-gray-900 text-yellow-400 w-full flex justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 mb-[-130px]"
    >
      <div className="max-w-[1000px] w-full text-center space-y-6">
        ...
        >
          <BellRing className="w-5 h-5 sm:w-6 sm:h-6 text-yellow-500 flex-shrink-0" />
          Subscription & Marketing Notices
        </h2>

        <p className="text-yellow-300 max-w-3xl mx-auto text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed px-2 sm:px-0">
