    ...
    <div className="bg-white text-gray-900 py-10 px-5 md:px-16 lg:px-24 flex flex-col items-center justify-center text-center my-10 mb-[-50px]">
      ...
      >
        <input
          ...
          className="w-full sm:flex-1 px-4 py-3 rounded-xl bg-white text-gray-900 placeholder-gray-400 border border-amber-700 focus:outline-none focus:border-amber-600 transition-all"
        />
        <button
          type="submit"
          className="px-6 py-3 rounded-xl bg-amber-700 text-gray-900 font-semibold hover:bg-amber-600 transition-all w-full sm:w-auto"
        >
          Subscribe
        </button>
      </form>
