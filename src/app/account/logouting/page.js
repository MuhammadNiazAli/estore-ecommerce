...
export default function LogoutingPage() {
  return (
    <main className="min-h-screen bg-gray-900 text-yellow-400 flex flex-col lg:flex-row max-w-[1200px] mx-auto pt-20 px-4 space-y-12 lg:space-y-0 lg:space-x-8">
      <AccountSidebar />
